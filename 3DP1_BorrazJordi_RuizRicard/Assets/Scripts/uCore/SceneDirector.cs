...
public struct GameScenes {
    public static string GSCENE_Inside = "Inside";
    public static string GSCENE_Outside = "Outside";
    public static string GSCENE_GameOver = "GameOver";
};
...
public class SceneDirector : MonoBehaviour {
    ...
    [Header("Scenes:")]
    [SerializeField]
    private Dictionary<string, BasicScene> m_Scenes;
    [SerializeField]
    ...
    public void AddScene(BasicScene scene) {
        if (m_Scenes == null)
            m_Scenes = new Dictionary<string, BasicScene>();
    ...
    // Método unload de las BasicScenes
    private void UnLoad() {
        m_Scenes[m_CurrentScene].UnLoad();
    }
